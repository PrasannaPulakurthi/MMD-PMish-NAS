...
## CELEBA
python MGPU_test_cpcompress.py --gpu_ids 0 --num_workers 1 --dataset celeba --bottom_width 8 --img_size 64 --arch arch_cifar10 --draw_arch False --checkpoint compress/celeba_small_1by20_2024_09_30_12_43_51 --genotypes_exp arch_cifar10 --latent_dim 120 --gf_dim 128 --num_eval_imgs 50000 --eval_batch_size 25 --exp_name test/compress_celeba_small --act pmishact --byrank

...
This repository contains code for our **2024 IEEE ACCESS** Journal paper "**Enhancing GANs with MMD Neural Architecture Search, PMish Activation Function and Adaptive Rank Decomposition,**" authored by [Prasanna Reddy Pulakurthi](https://www.prasannapulakurthi.com/), [Mahsa Mozaffari](https://mahsamozaffari.com/), [Sohail Dianat](https://www.rit.edu/directory/sadeee-sohail-dianat), [Jamison Heard](https://www.rit.edu/directory/jrheee-jamison-heard), [Raghuveer Rao](https://ieeexplore.ieee.org/author/37281258600), and [Majid Rabbani](https://www.rit.edu/directory/mxreee-majid-rabbani). [[PDF]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10732016) [[Paper]](https://ieeexplore.ieee.org/document/10732016) [[Website]](https://prasannapulakurthi.github.io/mmdpmishnas/)
...
<p align="center"><i>Example images generated by MMD-PMish-NAS across different datasets.</i></p>
...
<p align="center">
  <a href="https://paperswithcode.com/sota/image-generation-on-cifar-100?p=enhancing-gans-with-mmd-neural-architecture">
    <img src="https://img.shields.io/endpoint.svg?url=https://paperswithcode.com/badge/enhancing-gans-with-mmd-neural-architecture/image-generation-on-cifar-100">
  </a>

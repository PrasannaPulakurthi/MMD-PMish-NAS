...
### Compression
1. Compress and Finetune all the Convolutional Layers according to ARD.
   '''
    best_ranks = [
...
2. To Test the compressed network, download the compressed model from [Google Drive](https://drive.google.com/drive/folders/1xB6Y-btreBtyVZ-kdGTIZgLTjsv7H4Pd?usp=sharing) to ./exps/Compress/cifar10_small_1by15_xx/Model
